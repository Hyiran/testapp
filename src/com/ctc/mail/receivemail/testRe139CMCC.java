...
public class testRe139CMCC {
	...
	private void testLogin(AndroidDriver driver) {
		try {
			...
			components.testFirstLogin(driver,"CMCC",new User("18718879146","18879146"));
			sleep(10000);
	...
	public void inputToExcel(int caseNo) {
		try {
			ioManager.writeToExcelFile(fileDir + fileName, "testRe139CMCC", caseNo + "\t" + endtime + "\n");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
